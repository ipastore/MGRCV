...
if __name__ == "__main__":
    ...
    ################################
    D1_k_array = np.loadtxt("data/D1_k_array.txt")
    D2_k_array = np.loadtxt("data/D2_k_array.txt")
    K_1 = np.loadtxt("data/K_1.txt")
    K_2 = np.loadtxt("data/K_2.txt")
    T_leftRight = np.loadtxt("data/T_leftRight.txt")
    T_wAwB_gt = np.loadtxt("data/T_wAwB_gt.txt")
    T_wAwB_seed = np.loadtxt("data/T_wAwB_seed.txt")
    T_wc1 = np.loadtxt("data/T_wc1.txt")
    T_wc2 = np.loadtxt("data/T_wc2.txt")
    x1 = np.loadtxt("data/x1.txt")
    x2 = np.loadtxt("data/x2.txt")
    x3 = np.loadtxt("data/x3.txt")
    x4 = np.loadtxt("data/x4.txt")
    fisheye1_frameA = cv2.imread("data/fisheye1_frameA.png")
    fisheye1_frameB = cv2.imread("data/fisheye1_frameB.png")
    fisheye2_frameA = cv2.imread("data/fisheye2_frameA.png")
    fisheye2_frameB = cv2.imread("data/fisheye2_frameB.png")
