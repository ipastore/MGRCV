...
def visualize_residuals(x1Data, x1_p, image_pers_1):
...
if __name__ == '__main__':
    ...
    visualize_residuals(x1Data, x1_p, image_pers_1)
    visualize_residuals(x2Data, x2_p, image_pers_2)
    visualize_residuals(x3Data, x3_p, image_pers_3)
