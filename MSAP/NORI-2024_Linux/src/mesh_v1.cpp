...
void Mesh::samplePosition(const Point2f &sample, Point3f &p, Normal3f &n, Point2f &uv) const {
    ...
    float u = barycentric.x();                         // Coordenada baricéntrica para v0
    float v = barycentric.y();                         // Coordenada baricéntrica para v1
    float w = 1.0f - u - v;                            // Coordenada baricéntrica para v2
