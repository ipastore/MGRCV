...
private:
    ...
    std::vector<Eigen::Vector3d> gate_positions_;
    std::vector<Eigen::Vector3d> gate_normals_;
    std::vector<double> gate_angles_;
    std::vector<Eigen::Vector3d> gate_next_directions_;
    std::vector<double> gate_turn_angles_;
    double vel_max;
    double acc_max;
    ...
    void getGateNormal();
    void getGateAngles();
    void calculateGateVectorsAndAngles();
