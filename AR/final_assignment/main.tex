...
\begin{figure}[!ht]
    ...
    \fbox{\includegraphics[width=0.90\columnwidth]{images/rqt_graph.png}}
...
\begin{figure}[!ht]
    \centering
    \fbox{\includegraphics[width=0.8\columnwidth]{images/manhattan_maze_corridor.png}}
...
\begin{figure}[!ht]
    \centering
    \fbox{\includegraphics[width=0.8\columnwidth]{images/manhattan_blank.png}}
...
\begin{figure}[!ht]
    \centering
    \fbox{\includegraphics[width=0.8\columnwidth]{images/chebyshev_corridor.png}}
